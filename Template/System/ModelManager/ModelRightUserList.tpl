  ...
  <div class="list_table_main">
    <div id="J_ui_table" class="ui_table">
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        {foreach from=$arrayRightUserList item=data key=index}
          <tr class="{sdrclass rIndex=$index}">
            ...
            <li><a m="RoleManager" v="8" ispurview="true" href="javascript:;" onclick="DelUser({$data.user_id},{$data.right_id})">删除人员</a></li>
            </ul></div>
            </td>            
          </tr>
        {/foreach}
