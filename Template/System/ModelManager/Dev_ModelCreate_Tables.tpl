...
<script language="javascript" type="text/javascript">
 ...
 function ShowCreateQueryTable(tableName,table_comment)
 {
    window.open('/?a=MainPage#d=System&c=Dev_ModelCreate&a=ShowCreateQueryTable&table_name='+encodeURIComponent(tableName)+"&table_comment="+encodeURIComponent(table_comment),"");
 }
</script>
{/literal} 