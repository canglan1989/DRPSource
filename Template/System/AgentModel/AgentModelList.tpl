  ...
  <form action="" method="post" name="form1" id="form1">
    <div id="J_table_filter_main" class="table_filter_main">
      <div class="table_filter_main_row">
        ...
        <div class="ui_text">
          <input class="inpCommon accountName" type="text" maxlength="32" style="vertical-align:top;" name="texagentno" id="texagentno"/>
        </div>
        <div class="ui_title">代理商名称：</div>
        <div class="ui_comboBox">
          <input class="inpCommon accountName" type="text" maxlength="32" style="vertical-align:top;" name="texagentname" id="texagentname"/>
        </div>
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
      <thead class="ui_table_hd">
        <tr>
          ...
          <th  class="TA_l"><div class="ui_table_thcntr" sort="sort_convert(agent_name using gb2312)">
              <div class="ui_table_thtext">代理商名称</div>
            </div></th>
          <th class="TA_l"><div class="ui_table_thcntr" sort="sort_convert(product_series using gb2312)">
              <div class="ui_table_thtext">产品 </div>
            </div></th>
          <th ><div class="ui_table_thcntr">
              <div class="ui_table_thtext">代理商模板</div>
            </div></th>
          <th width="110" class="TA_r"><div class="ui_table_thcntr">
              <div class="ui_table_thtext">代理商模板/价格</div>
            </div></th>
          <th ><div class="ui_table_thcntr">
              <div class="ui_table_thtext">促销模板</div>
            </div></th>
          <th width="110" class="TA_r"><div class="ui_table_thcntr">
              <div class="ui_table_thtext">促销模板/价格</div>
            </div></th>
...
<script language="javascript" type="text/javascript">
 $(function(){
    ...
    {/literal}
	pageList.strUrl="{$AgentModelListBody}"; 
	{literal}
	pageList.param = "&"+$('#form1').serialize();
	pageList.init();
});
