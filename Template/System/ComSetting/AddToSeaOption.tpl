...
<form id="J_newBankAccount" class="newProductForm" name="J_newBankAccount" >
  <div class="bd">
    <div class="tf">
      ...
      <div class="inp">
          <input name="selectname" value="{$SelectOption}" id="selectname"  class="inpCommon"  valid="required"/>
      </div>
      <span class="info">请填入选项内容</span><span class="ok">&nbsp;</span><span class="err">选项内容不得为空</span> 
      </div>  
          <div class="tf">
