<!--S crumbs-->
	<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：<a href="javascript:;">注册客户管理</a><span>&gt;</span>客户资料转移</div>
    <!--E crumbs-->
    <div class="form_edit">
            <div class="form_hd">
...
<!--E sidenav_neighbour-->
	...
	$(function(){
        ...
        new Reg.vf($('#tableFilterForm'),{callback:function(data){
        	...
        	$.ajax({
        			type:'POST',
        			data:$('#tableFilterForm').serialize()+"&listid="+listid.join(","),
