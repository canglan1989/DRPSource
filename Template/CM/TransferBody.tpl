{foreach from=$arrayData item=data key=index}
  <tr>
    ...
    <input name="listid" class="checkInp listid" checked value="{$data.agent_customer_id}" type="hidden"/> 
    <!--
    <input name="listid" class="checkInp" value="{$data.customer_id}" type="checkbox"/>
    -->
    </div></td>
