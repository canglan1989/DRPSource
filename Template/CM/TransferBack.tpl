<!--S crumbs-->
	<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：<a href="javascript:;" onclick="JumpPage('{au d="CM" c="CMInfo" a="showBackInfoList"}')">客户查询</a><span>&gt;</span>客户资料转移</div>
    <!--E crumbs-->
    <div class="form_edit">
            <div class="form_hd">
                ...
                <form id="tableFilterForm" action="" name="tableFilterForm" class="customerMoveForm">
					...
					<div class="tf tf_submit" style="height:150px;">
						...
						<div class="inp">
                                                    ...
                                                    <div class="ui_button ui_button_cancel"><a class="ui_button_inner" href="javascript:;" onClick="JumpPage('{au d="CM" c="CMInfo" a="showBackInfoList"}')">取  消</a> </div>
...
<!--E sidenav_neighbour-->
	...
	$(function(){
        ...
        new Reg.vf($('#tableFilterForm'),{callback:function(data){
        	...
        	$.ajax({
        			type:'POST',
        			data:$('#tableFilterForm').serialize(),//+"&IntentionRating="+$("#ui_comboBox_IntentionRating").attr("key"), //.join(","),
