{foreach from=$arrayData item=data key=index}
  <tr>
    <td><div class="ui_table_tdcntr" name="oldValue">{$data.change_values}</div></td>
    <td><div class="ui_table_tdcntr" name="newValue">{$data.change_values}</div></td>
    <td><div class="ui_table_tdcntr">{$data.create_name}</div></td>
    <td><div class="ui_table_tdcntr">{$data.create_time}</div></td>
    <td><div class="ui_table_tdcntr">{$data.check_name}</div></td>
    <td><div class="ui_table_tdcntr">{$data.check_time}</div></td>
  </tr>
{/foreach}
<script type="text/javascript">
{literal}
//设置列表格值
//flag 列名 change_before--修改前 change_after--修改后
