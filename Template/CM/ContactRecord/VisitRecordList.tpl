...
<div class="table_filter marginBottom10">  
    ...
    <div id="J_table_filter_main" class="table_filter_main">    		
    	<div class="table_filter_main_row">
            ...
            <div class="ui_text">
                <input id="tbxSContactTime" type="text" class="inpCommon inpDate" name="tbxSContactTime" onClick="WdatePicker({literal}{maxDate:'#F{$dp.$D(\'tbxEContactTime\')}'}){/literal}"/>
                至
                <input id="tbxEContactTime" type="text" class="inpCommon inpDate" name="tbxEContactTime" onClick="WdatePicker({literal}{minDate:'#F{$dp.$D(\'tbxSContactTime\')}'}){/literal}"/>	
            </div> 
        </div>
	   <div class="table_filter_main_row">
            <div class="ui_title">拜访人：</div>
            ...
            <div id="divUserName" class="ui_text"><input type="text" name="CreateName" class="inpCommon" /></div>
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        	<thead class="ui_table_hd">
            	<tr class="">
                   ...
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">拜访人</div></div></th>
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">被拜访人</div></div></th>
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">被拜访人电话</div></div></th>
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">被拜访人手机</div></div></th>
                   <th><div class="ui_table_thcntr"><div class="ui_table_thtext">拜访主题</div></div></th>  
                   <th><div class="ui_table_thcntr"><div class="ui_table_thtext">拜访内容</div></div></th>  
                   <th width="80"><div class="ui_table_thcntr"><div class="ui_table_thtext">拜访时间</div></div></th>
...
$(function(){    
	{/literal}
	pageList.strUrl = "{$VisitRecordListBody}"; 
	{literal}    
