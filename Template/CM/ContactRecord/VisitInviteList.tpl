      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        	<thead class="ui_table_hd">
				...
				<th style="width:30px" title="全选/反选">
                   ...
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">预约被拜访人</div></div></th>
                   ...
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">预约拜访时间</div></div></th>
                   <th><div class="ui_table_thcntr"><div class="ui_table_thtext">预约拜访主题</div></div></th>
                   <th width="80"><div class="ui_table_thcntr"><div class="ui_table_thtext">拜访状态</div></div></th>   
...
$(function(){    
    $.setPurview();
	{/literal}
	pageList.strUrl = "{$VisitInviteListBody}"; 
	{literal}    
...
{
    JumpPage("/?d=CM&c=VisitRecord&a=VisitRecodeModify&inviteID="+id);
}
...
function DeleteInvite()
{
    ...
    var backData = $PostData("/?d=CM&c=VisitRecord&a=VisitInviteDel&ids="+ids);
...
function DropInvite(ids)
{
    ...
    var backData = $PostData("/?d=CM&c=VisitRecord&a=VisitInviteDrop&ids="+ids);
    if(parseInt(backData) == 0)
    {
        pageList.reflash();
        IM.tip.show("操作成功！"); 
...
function EditInvite(id)
{
    IM.dialog.show({
	    ...
	    start: function () {
		MM.get("/?d=CM&c=VisitRecord&a=VisitInviteModify&inviteID="+id, {}, function (backData) {
