{foreach from=$arrayData item=data key=index}
  <tr class="{sdrclass rIndex=$index}">
    ...
    <td title=""><div class="ui_table_tdcntr">{$data.invite_time}--{$data.invite_e_time}</div></td>    
    ...
    <td><div class="ui_table_tdcntr">        
            <ul class="list_table_operation">
                ...
                <li><a m="VisitRecordList" ispurview="true" v="4" href="javascript:;" onclick="AddVisitRecord({$data.recode_id})">添加拜访小记</a></li>                    
                <li><a m="VisitInviteList" ispurview="true" v="4" href="javascript:;" onclick="DropInvite({$data.recode_id})">作废</a></li>
                <li><a m="VisitInviteList" ispurview="true" v="4" href="javascript:;" onclick="EditInvite({$data.recode_id})">编辑预约</a></li>                
                {/if}
          </ul>
        </div>
      </td>
