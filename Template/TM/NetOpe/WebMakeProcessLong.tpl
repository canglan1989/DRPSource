        ...
        <div class="ui_table ui_table_nohead">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <thead class="ui_table_hd">
                    <tr>
                        <th><div class="ui_table_thcntr"><div class="ui_table_thtext">主步骤</div></div></th>
                <th><div class="ui_table_thcntr"><div class="ui_table_thtext">分步骤</div></div></th>
                <th><div class="ui_table_thcntr"><div class="ui_table_thtext">操作人</div></div></th>
                <th><div class="ui_table_thcntr"><div class="ui_table_thtext">所属代理商</div></div></th>
                ...
                <tbody class="ui_table_bd" id="ListContent">
                    {foreach from=$data item=arr}
                        <tr>
                            ...
                            <td><div class="ui_table_tdcntr">{$arr.part_step_name}</div></td>
                            <td><div class="ui_table_tdcntr">{$arr.ope_name}</div></td>
                            <td><div class="ui_table_tdcntr">{$arr.agent_name}</div></td>
