...
<tr class="{sdrclass rIndex=$index}">
    ...
    <td><div class="ui_table_tdcntr"><a onclick="ShowAgentCard({$data.agent_id})" href="javascript:;">{$data.agent_no}</a><br />{$data.agent_name}</div></td>
    ...
    <td title=""><div class="ui_table_tdcntr"><a onclick="UserDetial({$data.create_uid})" href="javascript:;">{$data.create_user_name}</a></div></td>
    <td title=""><div class="ui_table_tdcntr">{$data.create_time}</div></td>
    <td title=""><div class="ui_table_tdcntr">{$data.charge_type}</div></td>
</tr>
{/foreach}