...
<a href="javascript:;" onclick="JumpPage('/?d=FM&c=PreDeposits&a=PreDepositAccountAmount');">增值产品预存款账户</a><span>&gt;</span>{$strTitle}</div>
<!--E crumbs-->
<!--S table_filter-->
	...
	<div id="J_ui_table" class="ui_table">
    	<table width="100%" cellspacing="0" cellpadding="0" border="0">
        	...
        	<tr>
                ...
                <th class="TA_r" style="width:75px;" title="预存款(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">预存款(元)</div>
                    </div>
                </th>
                <th class="TA_r" style="width:75px;" title="销奖(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">销奖(元)</div>
                    </div>
                </th>
                <th class="TA_r" style="width:75px;" title="预存款扣款(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">预存款扣款(元)</div>
                    </div>
                </th>
                <th class="TA_r" style="width:75px;" title="销奖扣款(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">销奖扣款(元)</div>
                    </div>
                </th>
                <th class="TA_r" style="width:75px;" title="预存款退款(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">预存款退款(元)</div>
                    </div>
                </th>
                <th class="TA_r" style="width:75px;" title="销奖退款(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">销奖退款(元)</div>
                    </div>
                </th>
...
{
    window.open("/?d=FM&c=FM_Order&a=Back_ExportValueOrderPriceList" + pageList.param + "&sortField=" + pageList.sortField);
}
