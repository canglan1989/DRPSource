...
<div class="table_attention marginBottom10">
    <label>提醒信息：</label>
    <span class="ui_link">未审核：(<em>{$unCheckNum}</em>)</span>
</div> 
<!--E crumbs-->   
<div class="table_filter marginBottom10">  
        ...
        <div class="table_filter_main" id="J_table_filter_main">  
            <div class="table_filter_main_row">	    			
                ...
                <div id="ui_comboBox_agentPro" onClick="IM.comboBox.init({literal}{'control':'agentPro',data:MM.A(this,'data')}{/literal},this)" class="ui_comboBox ui_comboBox_def" key="" value="" data='{$arrProductType}' style="width:140px;">
            ...
            <div class="table_filter_main_row">
                ...
                <div class="ui_text">
                    <input type="text" id="J_editTimeS" class="inpCommon inpDate" name="editTimeS" onFocus="WdatePicker({literal}{onpicked:function(){($dp.$('J_editTimeE')).focus()},maxDate:'#F{$dp.$D(\'J_editTimeE\')}'}{/literal})"> 至
                    <input type="text" id="J_editTimeE" class="inpCommon inpDate" name="editTimeE" onFocus="WdatePicker({literal}{minDate:'#F{$dp.$D(\'J_editTimeS\')}'}{/literal})">
                </div>                     
