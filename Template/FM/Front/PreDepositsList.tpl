	...
	<div class="ui_table" id="J_ui_table">                    	
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        	<thead class="ui_table_hd">
            	<tr class="">             
                   <th width="90"><div class="ui_table_thcntr"><div class="ui_table_thtext">预存款类型</div></div></th>                   	
                   <th width="90"><div class="ui_table_thcntr"><div class="ui_table_thtext">预存款交易号</div></div></th>
                   <th width="60"><div class="ui_table_thcntr"><div class="ui_table_thtext">产品</div></div></th>
                   <th><div class="ui_table_thcntr"><div class="ui_table_thtext">合同号/有效时间</div></div></th>
                   <th class="TA_r" width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">打款金额(元)</div></div></th>
                   <th><div class="ui_table_thcntr"><div class="ui_table_thtext">打款信息</div></div></th>   
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">操作人/打款时间</div></div></th>
                   ...
                   <th width="80"><div class="ui_table_thcntr"><div class="ui_table_thtext">收据号</div></div></th>
...
$(function(){    
	...
	pageList.strUrl = "{$PreDepositsListBody}"; 
	{literal}
...
function ShowInvoiceIsseuInfo(id)
{
    IM.dialog.show({
         width: 350,
    	    ...
    	    start: function () {
    	       $('.DCont').html($PostData("/?d=FM&c=PreDeposits&a=ShowInvoiceIsseuInfo","id="+id)); 
        }
    });    
}
...
{
    window.open("/?d=FM&c=PreDeposits&a=ExcelExportPreDepositsList" + pageList.param + "&sortField=" + pageList.sortField);
}
{/literal}
{if $SYS_EVN != 2}
{literal}
...
{
    alert("底单入款确认测试！");
    var data = $PostData("/?d=FM&c=PreDeposits&a=Test_UpdatePostMoneyState&id="+id,"");
    alert(data);
    pageList.reflash();
}

function TestCheck1(id)
{
    alert("到账确认测试！");
    var data = $PostData("/?d=FM&c=PreDeposits&a=Test_PostPriceAudit&id="+id,"");
    alert(data);
    pageList.reflash();
}


function Test_OpenReceipt(id,money)
{
    alert("开收据测试！");
    var data = $PostData("/?d=FM&c=Receipt&a=Test_OpenReceipt","ids="+id+"&money="+money);
    alert(data);
    pageList.reflash();
}
{/literal}
