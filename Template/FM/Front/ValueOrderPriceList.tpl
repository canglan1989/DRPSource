<!--S crumbs-->
<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：财务管理<span>&gt;</span>
<a href="javascript:;" onclick="JumpPage('/?d=FM&c=PreDeposits&a=PreDepositsAccount');">预存款账户查询</a><span>&gt;</span>{$strTitle}</div>
<!--E crumbs-->
<!--S table_filter-->
<div class="table_filter marginBottom10">  
    ...
    <div class="table_filter_main_row">
        ...
        <div class="ui_text"><input id="tbxCustomerName" type="text" name="tbxCustomerName" style="width:200px;" value="" maxlength="48" /></div>
    ...
    <div class="table_filter_main_row">        
        ...
        <div class="ui_text">
            <input id="J_editTimeS1" type="text" class="inpCommon inpDate" name="tbxChargeSDate" onClick="WdatePicker({literal}{maxDate:'#F{$dp.$D(\'J_editTimeE1\')}'}){/literal}"/>
            至
            <input id="J_editTimeE1" type="text" class="inpCommon inpDate" name="tbxChargeEDate" onClick="WdatePicker({literal}{minDate:'#F{$dp.$D(\'J_editTimeS1\')}'}){/literal}"/>	
        </div>
	...
	<div id="J_ui_table" class="ui_table">
    	<table width="100%" cellspacing="0" cellpadding="0" border="0">
        	...
        	<tr>
                ...
                <th class="TA_r" style="width:100px;" title="销奖(元)">
                	<div class="ui_table_thcntr ">
                    	<div class="ui_table_thtext">销奖(元)</div>
                    </div>
                </th>
...
$(function(){
    ...
    $GetProduct.BindSignedProductType("cbProductType",true,ProductGroups.ValueIncrease);
    
    {/literal}
    var productTypeID = parseInt({$qProductTypeID});
    var priceStatus = parseInt({$priceStatus});
    pageList.strUrl = "{$ValueOrderPriceListBody}"; 
    {literal}
...
{
    window.open("/?d=FM&c=FM_Order&a=ExportValueOrderPriceList" + pageList.param + "&sortField=" + pageList.sortField);
}
