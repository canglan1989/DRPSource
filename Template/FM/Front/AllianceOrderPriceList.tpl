...
<a href="javascript:;" onclick="JumpPage('/?d=FM&c=PreDeposits&a=UnitPreDepositsAccount');">网盟预存款账户查询</a><span>&gt;</span>{$strTitle}</div>
<!--E crumbs-->
<!--S table_filter-->
...
$(function(){
    ...
    pageList.strUrl = "{$AllianceOrderPriceListBody}"; 
    {literal}
