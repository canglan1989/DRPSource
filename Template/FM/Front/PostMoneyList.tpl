      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        	<thead class="ui_table_hd">
            	<tr class="">                                	
                   ...
                   <th width="90"><div class="ui_table_thcntr"><div class="ui_table_thtext">打款产品</div></div></th>
...
$(function(){    
	...
	{/literal}
	pageList.strUrl = "{$PostMoneyListBody}"; 
	{literal}
...
{
    IM.finance.ReceiptConfirm("/?d=FM&c=Receipt&a=ConfirmReceipt",{'id':id},"收据确认");
}
