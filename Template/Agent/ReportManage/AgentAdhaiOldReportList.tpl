...
<div class="table_attention marginBottom10">
    <label>统计信息：</label>
    <span class="ui_link">累计新开：(<em>{$NewCount}</em>)</span>
    <span class="ui_link">累计新开金额：(<em>{$NewMoney}</em>)</span>
    <span class="ui_link">累计续费：(<em>{$OldCount}</em>)</span>
    <span class="ui_link">累计续费金额：(<em>{$OldMoney}</em>)</span>
</div> 
<!--S table_filter-->
<!--S table_filter-->
