...
<tr>
    ...
    <td title="{$arrReportList.new_count}"><div class="ui_table_tdcntr"><a href="javascript:void(0)" onclick="jump2sign('{$arrReportList.e_name}','{$arrReportList.begin_time}');">{$arrReportList.new_count}</a></div></td>
