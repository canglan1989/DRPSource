<!--S crumbs-->
<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：<a onclick="JumpPage('{au d='Agent' c='Agent' a='showChannelPager'}')" href="javascript:";>我的渠道</a><span>&gt;</span>添加代理商</div>
<!--E crumbs--> 
<!--S form_edit-->
<div class="form_edit">
  <div class="form_hd">
  ...
  <div class="form_bd">
    <form id="J_agentAddForm" name="agentAddForm" class="agentAddForm">
      <div class="form_block_hd">
        ...
        {if $iCanAddAgent == 0  && $isCheck == 0}<span id="spanNote" style="color:red">您好，您的个人库代理商数量已经超过限制。</span>{/if}</div>
      <!--S form_block_bd-->
      <div class="form_block_bd">
        ...
        <div class="tf">
          <label>注册时间：</label>
          <div class="inp">
            <input type="text" class="registeredTime inpDate" name="reg_date" onClick="WdatePicker({literal}{maxDate:'%y-%M-%d'}{/literal})" id="reg_date"/>
          </div>
        </div>
        <div class="tf">
          <label>公司规模：</label>
      ...
      <div class="form_block_bd">
        ...
        <div class="tf tf_submit">
          <label>&nbsp;</label>
          <div class="inp"> {if $isCheck == 1 || $iCanAddAgent == 1}
...
new Reg.vf($('#J_agentAddForm'),{
        ...
        $.ajax({
                ...
                {/literal}
                url:'{au d="Agent" c="Agent" a="AddAgent"}',
                {literal}
				dataType:'json',
...
//代理商资质上传
new IM.upload({id:'J_upload0',noticeId:'J_uploadImg0',{/literal} url: '{au d="Agent" c="Agent" a="FileUpload"}'{literal}});
