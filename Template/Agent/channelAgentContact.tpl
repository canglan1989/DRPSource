...
<div class="form_edit">
  <div class="form_hd">
    <ul>
      <li> <a href="javascript:;" onclick="JumpPage('{au d='Agent' c='Agent' a='pactAgentContact'}');">
      ...
      <li class="cur"> <a href="javascript:;" onclick="JumpPage('{au d='Agent' c='Agent' a='channelAgentContact'}');">
        <div class="form_hd_left">
          <div class="form_hd_right">
            <div class="form_hd_mid">
              <h2>潜在代理商</h2>
        ...
        <form action="" method="post" id="tableFilterForm" name="tableFilterForm">
          <div class="table_filter_main" id="J_table_filter_main">
            <div class="table_filter_main_row">
              ...
              <div class="ui_comboBox">
                <input id="e_name" class="inpCommon" type="text" name="ctlUser" value="{$eName}" style="vertical-align:top;"/>
              </div>
            </div>
            <div class="table_filter_main_row">
