        ...
        <div class="form_edit">
            ...
            <div class="form_block_bd">
                <div class="tf">
                    ...
                    <div class="inp">{$arrFromManage.cur_agent_name}</div>
                    <input type="hidden" name="pactIds" value="{$ids}" />
                </div>
            </div>
            ...
            <div class="form_block_bd">
                    ...
                    <div class="side_l">
                        <div class="tf">
                            ...
                            <div class="inp">{$arrFromManage.e_name}</div>
                            <input type="hidden" name=agentid[] value="{$arrFromManage.agent_id}">
                            <input type="hidden" name=fromid[] value="{$arrFromManage.channel_uid}">
                        </div>
                    </div>
                    <div class="side_r">
                        <div class="tf"><label style="width:150px;">原渠道经理主账号：</label><div class="inp">{$arrFromManage.user_name}</div></div>
                    </div>
