...
<div class="form_edit">
  <div class="form_hd">
    <ul>
      ...
      <li> <a href="javascript:;" onclick="JumpPage('{au d='Agent' c='Agent' a='agentPotentialList'}');">
        <div class="form_hd_left">
          <div class="form_hd_right">
            <div class="form_hd_mid">
              <h2>潜在代理商</h2>
        ...
        <div class="table_filter_main" id="J_table_filter_main">
          <div class="table_filter_main_row">
            ...
            <div id="ui_comboBox_IntentionRating" onclick="IM.comboBox.init({'control':'industry',data:MM.A(this,'data')},this)" 
                            {/literal}
                             class="ui_comboBox ui_comboBox_def" key="" value="" control="industry" data="{$industry}" style="width:120px;">
