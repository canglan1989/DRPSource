...
<div class="form_block_bd">                                 
        <div class="tf">
         <label><em class="require">*</em>代理的产品：</label>
            ...
            {foreach item=pro from=$arrProductType key=key}
   ...
   <span class="info">请输入预存款</span>
        ...
        <div class="tf">
         <label><em class="require">*</em>合同有效期限：</label>
            <div class="inp">
                <input type="text" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('J_editTimeE1')).focus()},maxDate:'#F{$dp.$D(\'J_editTimeE1\')}'}{/literal})" name="pact_sdate" class="inpCommon inpDate" id="J_editTimeS1"  valid="required"> 至
                <input type="text" onfocus="WdatePicker({literal}{minDate:'#F{$dp.$D(\'J_editTimeS1\')}'}{/literal})" name="pact_edate" class="inpCommon inpDate" id="J_editTimeE1" valid="required">
            </div> 
...
<div class="form_block_bd" style="padding-bottom:0;">                 
    <div class="tf">
        ...
        <div class="inp">
            ...
            <input class="detailAddress" type="text" name="sign_address" id="sign_address" valid="required detailAddress"  value="{$arrAgentSourceInfo.address}" tabindex="5" onfocus="if(this.value=='请输入详细街道地址')this.value='';this.style['color']='#555555'" />
        </div>
 ...
 <div class="tf">
        <label>邮政编码：</label>
        <div class="inp"><input class="postcode" name="sign_postcode" id="sign_postcode" valid="postcode" maxlength="6" tabindex="6" type="text" value="{$arrAgentSourceInfo.postcode}"></div>
 ...
 <div class="tf">
    ...
    <div class="tf">
         <label><em class="require">*</em>负责人姓名：</label>
            <div class="inp"><input class="principalName" type="text" name="sign_charge_person" id="sign_charge_person" valid="required principalName" value="{$arrAgentSourceInfo.charge_person}"/></div>
