<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：代理商管理<span>&gt;</span>签约管理<span>&gt;</span>部门签约审核<span>&gt;</span>合同续签</div>
<div class="form_edit">
        	<div class="form_hd">
            ...
            <div class="form_bd">
                ...
                <div class="form_block_bd">                	                
                        <div class="tf">
                            ...
                            <div class="inp">
                            {literal}<div style="width:100px;" id="ui_comboBox_agentPro" data={/literal}'{$arrProductType}' value="" key="{$arrPactInfo.product_id}"{literal} control="agentpro" class="ui_comboBox ui_comboBox_def ui_comboBox_dis" disabled="disabled" onclick="IM.comboBox.init({'control':MM.A(this,'control'),data:MM.A(this,'data')},this)">{/literal}

                            <div style="width:80px;" class="ui_comboBox_text">
                                <nobr>{if $srtProName eq ''}请选择代理产品{else}{$srtProName}{/if}</nobr>
                            </div>
					    ...
					    <!--               		
                                            <div class="ui_button" onclick="IM.setAreaAgent.add('.treeview2')" ><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_text">添加&gt;&gt;</div></div></div>
                                              ...
                                              -->
                                              <div class="ui_button" onclick="disable()" ><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_text">添加&gt;&gt;</div></div></div>
					      <div class="ui_button ui_button_dis" onclick="disable()"><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_text">&lt;&lt;移除</div></div></div>
                                        </div>
                                        <div class="areaRight">
                                        	<h4>已选择地区</h4>
                                            <div class="AllArea">
                                            <ul id="Selected" class="treeview2" disabled="disabled">
                                                {$selectAreaHTML}
                                            </ul>
                                            </div>
                                        </div>
                                    </div>
				    <div class="agentArea_dis"></div> 
                                </div>
                                <!--E agentArea--> 
                        ...
                        <div class="tf">
                        	<label><em class="require">*</em>代理商等级：</label>
                                <input type="hidden" valid="required" name="agent_level" value="{$arrPactInfo.agent_level}" id="agent_level">
                            <div class="inp">
                            	<select id="agent_level" valid="required agent_level" disabled="disabled">
                        ...
                        <div class="tf">
                            ...
                            <div class="inp">
                                <input type="hidden" valid="required" name="agent_mode" value="{$arrPactInfo.agent_mode}" id="J_coopModel">
                            	<select id="J_coopModel"  disabled="disabled">
                ...
                <div class="form_block_hd"><h3 class="ui_title">代理商信息</h3>
                    <!--<a href="javascript:;" onClick="IM.agent.getInfo({literal}{'action':'more'}{/literal})">展开</a>
                    --></div>
                <div class="form_block_bd" style="padding-bottom:0;">                	
                    <div class="tf">
                        <label><em class="require">*</em>联系地址：</label>
                        <div class="inp">
                            <input type="hidden" valid="required" name="sign_area_id" value="{$arrAgentSourceInfo.area_id}">
                            <select id="selProvince" class="pri" name="sign_province_id" tabindex="2" disabled="disabled"></select>
                            <select id="selCity" class="city" name="sign_city_id" tabindex="3" disabled="disabled"></select>
                            <select id="selArea" class="area" tabindex="4" disabled="disabled"></select>
                            <input class="detailAddress" type="text" name="sign_address" id="sign_address" valid="required"  value="{$arrAgentSourceInfo.address}" tabindex="5" onfocus="if(this.value=='请输入详细街道地址')this.value='';this.style['color']='#555555' "readonly="readonly"/>
                        </div>
					...
					<div class="tf">
                        <label>邮政编码：</label>
                        <div class="inp"><input class="postcode" name="sign_postcode" id="sign_postcode" maxlength="6" tabindex="6" type="text" value="{$arrAgentSourceInfo.postcode}" readonly="readonly"></div>
			...
			-->		</div>
                    <div class="tf">
                            ...
                            <input type="hidden" valid="required" name="sign_reg_area_id" value="{$arrAgentSourceInfo.reg_area_id}">
                            <div class="inp">
                            <select id="sign_reg_province_id" class="pri" name="sign_reg_province_id" tabindex="2" disabled="disabled"></select>
                            <select id="sign_reg_city_id" class="city" name="sign_reg_city_id" tabindex="3" disabled="disabled"></select>
                            <select id="sign_reg_area_id" class="area" tabindex="4" valid="required" disabled="disabled"></select>
                            </div>
                    ...
                    <div class="tf">
                            ...
                            <div class="inp"><input valid="required" name="sign_legal_person" id="sign_legal_person" type="text" value="{$arrAgentSourceInfo.legal_person}" readonly="readonly"/></div>
					...
					<div class="tf">
                            ...
                            <div class="inp">
                            <input valid="required" type="text" name="sign_reg_capital" id="sign_reg_capital" value="{$arrAgentSourceInfo.reg_capital}" readonly="readonly"/>
                            </div>
                    ...
                    <div class="tf">
                        	<label>营业执照注册号：</label>
                            <div class="inp"><input class="LegalPersonName" value="{$arrAgentSourceInfo.permit_reg_no}" type="text" name="sign_permit_reg_no" id="sign_permit_reg_no"  valid=""  tabindex="7" readonly="readonly"/></div>
                            <!--<span class="info">请输入营业执照注册号</span>
                            <span class="ok">&nbsp;</span><span class="err">请输入营业执照注册号</span>-->
					</div>
                    <div class="tf">
                        	<label><em class="require">*</em>法人身份证号：</label>
                            <div class="inp"><input class="LegalPersonName" value="{$arrAgentSourceInfo.legal_person_ID}" type="text" name="sign_legal_person_ID" id="sign_legal_person_ID"  valid="required"  tabindex="7" readonly="readonly"/></div>
                            <span class="info">请输入法人身份证号</span>
                            <span class="ok">&nbsp;</span><span class="err">请输入法人身份证号</span>
					</div>
					<div class="tf">
                        	<label>企业税号：</label>
                            <div class="inp"><input class="LegalPersonName" value="{$arrAgentSourceInfo.revenue_no}" type="text" name="sign_revenue_no" id="sign_revenue_no"  valid=""  tabindex="7"readonly="readonly"/></div>
                            <!--<span class="info">请输入企业税号</span>
                            <span class="ok">&nbsp;</span><span class="err">请输入企业税号</span>-->
					</div>
                    <div class="tf">
                        	<label><em class="require">*</em>负责人姓名：</label>
                            <div class="inp"><input class="principalName" type="text" name="sign_charge_person" id="sign_charge_person" valid="required" value="{$arrAgentSourceInfo.charge_person}" readonly="readonly"/></div>
                            <span class="info">请如实填写</span>
                            <span class="ok">&nbsp;</span><span class="err">请如实填写</span>
					</div>                        
					<div class="tf">
                        	<label><em class="require">*</em>手机号：</label>
                            <div class="inp"><input class="mPhone" type="text" name="sign_charge_phone" id="sign_charge_phone" valid="mPhone" value="{$arrAgentSourceInfo.charge_phone}" readonly="readonly"/></div>
					...
					<div class="tf">
                            ...
                            <div class="inp"><input class="fPhone" type="text" name="sign_charge_tel" id="sign_charge_tel" valid="fPhone" value="{$arrAgentSourceInfo.charge_tel}" readonly="readonly"/></div>
                ...
                <div class="form_block_ft">
                	<div class="agentAuditBlock" style="margin:0;">
                        <div class="tf">
                                ...
                                <div class="inp"><textarea id="pact_remark" class="" name="pact_remark" valid="required " readonly="readonly">{$arrPactInfo.pact_remark}</textarea></div>
                        ...
                        <div class="tf tf_submit">
                            ...
                            <div class="inp">
                            	...
                            	<div class="ui_button" style="margin-right:10px;">
                                    <div class="ui_button_left"></div>
                                    <div class="ui_button_inner">
                                        <div class="ui_text">
                                            <button type="submit" name="submitNext"  style="background:none; color:#fff;">
                                                提交并保存</button>
                                        </div>
                                    </div></div>
                                <!-- <div class="ui_button" style="margin-right:10px;"><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_text"><button type="submit" name="submit"  style="background:none; color:#fff;" onclick="{if $pactType eq 1}$('#subtype').val(1);{else}$('#subtype').val(2);{/if}">保 存</button></div></div></div>-->
...
function addTiJiaoQYFormEventListener(){
	...
	callback:function(formdata){////formdata 表单提交数据 对象数组格式
        ...
        _InDealWith = true;
		MM.ajax({
			url:'/?d=Agent&c=AgentMove&a=addRenewal',
...
{/literal}
document.getElementById("J_upload0").disabled=true;
document.getElementById("J_upload1").disabled=true;
document.getElementById("J_upload2").disabled=true;
document.getElementById("J_upload3").disabled=true;
document.getElementById("J_upload4").disabled=true;
