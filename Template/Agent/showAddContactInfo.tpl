...
<form id="J_newLXXiaoJi" action="" name="newLXXiaoJiForm" class="newLXXiaoJiForm">
    <div class="bd">
        <div class="tf">
            ...
            <div class="inp">
                <input class="contact_name" type="text" name="contact_name" id="contact_name"  valid="required customerName" maxlength="18" tabindex="1" value="{$contact_name}"/>
                <input type="hidden" name="agentId" id="agentId" value="{$agentId}">
                <input type="hidden" name="isPact" id="isPact" value="{$isPact}">
                <input type="hidden" name="isCharge" id="isCharge" value="{$isCharge}"> <!--用来比较前后的负责人是否变-->
                <input name="ischarge" type="checkbox" class="checkInp" id="ischarge" style="margin-top:3px; vertical-align:middle" value="1" {if $ischarge eq 100}checked="checked"{/if}/> 是负责人</span>
            </div>
        ...
        <div class="tf">
            ...
            <div class="inp"><input class="mPhone" type="text" name="mobile"   valid="mPhone" id="mobile" value="{$mobile}"/></div>
            <span class="info" style="display:inline">手机号或固定电话必须输入一项</span>
            <span class="ok">&nbsp;</span><span class="err">请输入正确手机号</span>
        </div>
        <div class="tf">
            <label>固定电话：</label>
            <div class="inp"><input class="fPhone" type="text" name="phone"   valid="fPhone" id="phone" value="{$tel}"/></div>
        ...
        <div class="tf">
            ...
            {if $isInvite eq 1}checked="checked"{/if}/>
            </div>
        </div>   
        {if $isSigned==0}                                           
        <div class="tf">
            ...
            <div class="inp">
                <select tabindex="8" name="leval" id="leval">                                
                    ...
                    <option value="A" {if $arrExpect.inten_level=="A"} selected="selected" {/if}>A</option>
                    <option value="B+" {if $arrExpect.inten_level=="B+"} selected="selected" {/if}>B+</option>
        ...
        <div class="tf">
            <label>预计到账概率：</label>
            <div class="inp"><input type="text"  name="expectPercent" id="expectPercent" style="width:50px;" value="{$arrExpect.charge_percentage}" valid="amount"><span>%</span></div>
        ...
        <div class="tf">
            <label>传真号码：</label>
            <div class="inp"><input class="faxPhone" type="text" name="fax" valid="faxPhone" id="fax" value="{$fax}"/></div>
            <span class="info">格式：0571-88888888</span>
            <span class="ok">&nbsp;</span><span class="err">请输入正确传真号码</span>
        </div>
        <div class="tf">
            <label>电子邮箱：</label>
            <div class="inp"><input class="email" type="text" name="email" id="email" valid="email" value="{$email}"/></div>
            <span class="info">请输入正确邮箱</span>
            <span class="ok">&nbsp;</span><span class="err">请输入正确邮箱</span>
        </div>                        
        <div class="tf">
            <label>职务：</label>
            <div class="inp"><input class="office" type="text" name="position" id="position" value="{$position}"/></div>
        </div>
        <div class="tf">
            <label>MSN：</label>
            <div class="inp"><input class="MSN" type="text" name="msn" id="msn" value="{$msn}"/></div>
        </div>
        <div class="tf">
            <label>QQ：</label>
            <div class="inp"><input class="QQ" type="text" name="qq" id="qq" value="{$qq}"/></div>
        </div> 
    </div>
    <div class="ft">
