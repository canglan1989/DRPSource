                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                       <tbody class="ui_table_bd">
                                            <tr class="">
                                                ...
                                                <td><div class="ui_table_tdcntr">{$arrayData.0.appoint_id}</div></td>
                                            ...
                                            <tr class="">
                                                <td class="even"><div class="ui_table_tdcntr">签约状态</div></td>
                                                <td><div class="ui_table_tdcntr">{if $arrayData.0.product_name != ""}已签约{else}未签约{/if}</div></td>
                                                <td class="even"><div class="ui_table_tdcntr">预约时的意向评级/签约产品</div></td>
                                                <td><div class="ui_table_tdcntr">{if $arrayData.0.product_name != ""}{$arrayData.0.product_name}{else}{$arrayData.0.inten_level}{/if}</div></td>
                                            </tr>
                                            <tr class="">
