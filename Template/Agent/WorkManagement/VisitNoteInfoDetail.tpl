        ...
        <div class="list_table_main">
            <div class="ui_table ui_table_nohead">
                ...
                <tr class="">
                    ...
                    <td colspan="3"><div class="ui_table_tdcntr">{$NoteInfo->strVisitContent}</div></td>
                </tr>
                <tr class="">
                    <td class="even"><div class="ui_table_tdcntr">下次拜访时间</div></td>
                    <td colspan="3"><div class="ui_table_tdcntr">{$NoteInfo->strFollowUpTime|date_format:'%Y-%m-%d'}</div></td>
                </tr>
            </tbody>
        </table>   
    </div>
