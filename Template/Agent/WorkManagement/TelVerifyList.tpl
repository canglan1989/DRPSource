...
<div class="list_link marginBottom10">
    <a class="ui_button" m="TelVerify" v="2" ispurview="true" onclick="pageList.ExportExcel()" href="javascript:;">
...
<div class="list_table_main">
    <div id="J_ui_table" class="ui_table">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <th width="60" title="意向等级">
            <div class="ui_table_thcntr" >
                <div class="ui_table_thtext">意向等级</div>
            </div>
            </th>
            <th width="70" title="被联系人">
            <div class="ui_table_thcntr">
            ...
            <th width="300" title="联系小记">
            <div class="ui_table_thcntr">
                <div class="ui_table_thtext">联系小记</div>
            </div>
            </th>
            <th width="120" title="行业动态">
            <div class="ui_table_thcntr">
