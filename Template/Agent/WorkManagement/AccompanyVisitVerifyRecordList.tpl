    ...
    <form action="" name="tableFilterForm" id="tableFilterForm">
        <div id="J_table_filter_main" class="table_filter_main">
            <div class="table_filter_main_row">
                ...
                <div class="ui_title" id="divCreateUserTitle">陪访人：</div>
            ...
            <div class="table_filter_main_row">
                ...
                <div class="ui_text">
                    <input id="tbxCreateTimeS" class="inpCommon inpDate" name="tbxCreateTimeS" value="" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('tbxCreateTimeE')).focus()},dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'tbxCreateTimeE\')}'}){/literal}" type="text"/>
                    至
                    <input id="tbxCreateTimeE" class="inpCommon inpDate" name="tbxCreateTimeE" value="" onfocus="WdatePicker({literal}{minDate:'#F{$dp.$D(\'tbxCreateTimeS\')}',dateFmt:'yyyy-MM-dd'}{/literal})" type="text"/>
                </div>
                <div class="ui_title">质检结果：</div>
                <div class="ui_comboBox">
                    <select id="cbAuditState" name="cbAuditState">
                        <option value="-100" selected="selected">全部</option>                         
                         <option value="1">质检通过</option>                        
                         <option value="-1">质检未通过</option>
                         <option value="2">不质检</option>
                    </select>
                </div>
                <div class="ui_title">质检时间：</div>
                <div class="ui_text">
                    <input id="tbxCheckTimeS" class="inpCommon inpDate" name="tbxCheckTimeS" value="" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('tbxCheckTimeE')).focus()},dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'tbxCheckTimeE\')}'}){/literal}" type="text"/>
                    至
                    <input id="tbxCheckTimeE" class="inpCommon inpDate" name="tbxCheckTimeE" value="" onfocus="WdatePicker({literal}{minDate:'#F{$dp.$D(\'tbxCheckTimeS\')}',dateFmt:'yyyy-MM-dd'}{/literal})" type="text"/>
                </div>
    ...
    <div id="J_ui_table" class="ui_table">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <thead class="ui_table_hd">
                <tr>
                    <th width="80" title="小记编号"> <div class="ui_table_thcntr" >
                <div class="ui_table_thtext">小记编号</div>
                <div class="ui_table_thsort" sort="sort_id"></div>
            </div>
            </th>
            <th width="150" title="代理商名称"> <div class="ui_table_thcntr" >
                <div class="ui_table_thtext">代理商名称</div>
                <div class="ui_table_thsort" sort="sort_agent_name"></div>
            </div>
            </th>
            <th width="70" title="陪访人"> <div class="ui_table_thcntr" >
                <div class="ui_table_thtext">陪访人</div>
            ...
            <th width="90" title="提交时间"> <div class="ui_table_thcntr">
                <div class="ui_table_thtext">提交时间</div>
            </div>
            </th>
            <th width="130" title="质检位置">
            ...
            <th width="70" title="质检人">
            	<div class="ui_table_thcntr">
                	<div class="ui_table_thtext">质检人</div>
                </div>
            </th>
            <th width="90" title="质检时间">
            	<div class="ui_table_thcntr">
                	<div class="ui_table_thtext">质检时间</div>
                </div>
            </th>
            </tr>
            </thead>
...
$(document).ready(function () {
    {/literal}
    pageList.strUrl="{$AccompanyVisitVerifyRecordListBody}";
    pageList.sortField = "check_time desc,id desc";
