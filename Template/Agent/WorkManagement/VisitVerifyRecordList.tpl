        ...
        <div class="ui_title">拜访时间：</div>
         ...
         <div class="table_filter_main_row">
             <div class="ui_title">提交人：</div>
                ...
                <div class="ui_title">质检操作时间：</div>
                <div class="ui_text">
                    <input id="vertify_time_start" type="text" class="inpCommon inpDate" name="vertify_time_start" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('vertify_time_end')).focus()},maxDate:'#F{$dp.$D(\'vertify_time_end\')}'}{/literal})"/> 至
                    <input id="vertify_time_end" type="text" class="inpCommon inpDate" name="vertify_time_end" onfocus="WdatePicker({literal}{minDate:'#F{$dp.$D(\'vertify_time_start\')}'}{/literal})"/>
                </div> 
