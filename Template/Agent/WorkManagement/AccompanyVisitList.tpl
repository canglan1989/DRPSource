    ...
    <form action="" name="tableFilterForm" id="tableFilterForm">
        <div id="J_table_filter_main" class="table_filter_main">
            ...
            <div class="table_filter_main_row">
                ...
                <div class="ui_comboBox">
                    <select id="cbAuditState" name="cbAuditState">
                        <option value="-100" selected="selected">全部</option>
                         {foreach from=$arrayCheck item=data key=index}
                ...
                <div class="ui_title">小记制定人：</div>
                <div class="ui_comboBox">
                    <select id="cbCreateUserType" name="cbCreateUserType" onchange="CreateUserTypeChange(this)">
                    <option value="-100" selected="selected">全部</option>
...
<div class="list_table_main">
    <div id="J_ui_table" class="ui_table">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <th width="70" title="质检状态"> <div class="ui_table_thcntr ">
...
{/literal}
pageList.strUrl="{$AccompanyVisitListBody}"; 
pageList.param = "&"+$('#tableFilterForm').serialize();//get 获取！     
{literal}
pageList.init();
});

function CreateUserTypeChange(obj)
{
    if(parseInt(obj.value) == 1)
    {
        $("#divCreateUserTitle").hide();
        $("#divCreateUserText").hide();        
    }
    else
    {
        $("#divCreateUserTitle").show();
        $("#divCreateUserText").show();   
    }
}
