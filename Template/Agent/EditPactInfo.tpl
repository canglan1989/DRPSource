<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：我的渠道<span>&gt;</span>提交签约</div>
<div class="form_edit">
        	<div class="form_hd">
            ...
            <div class="form_bd">
                ...
                <div class="form_block_bd">                	                
                        <div class="tf">
                            ...
                            <div class="inp">
                            {literal}<div style="width:100px;" id="ui_comboBox_agentPro" data={/literal}'{$arrProductType}' value="{$srtProName}" key="{$arrPactInfo.product_id}"{literal} control="agentPro" class="ui_comboBox ui_comboBox_def" onclick="IM.comboBox.init({'control':MM.A(this,'control'),data:MM.A(this,'data')},this)">{/literal}
                        ...
                        <div class="tf">
                            ...
                            <div class="inp">
                                <input type="text" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('J_editTimeE1')).focus()},maxDate:'#F{$dp.$D(\'J_editTimeE1\')}'}{/literal})" name="pact_sdate" class="inpCommon inpDate" id="J_editTimeS1"  valid="required" value="{$arrPactInfo.pact_sdate}"> 至
                ...
                <div class="form_block_bd" style="padding-bottom:0;">                	
                    <div class="tf">
                        ...
                        <div class="inp">
                            ...
                            <input class="detailAddress" type="text" name="sign_address" id="sign_address" valid="required"  value="{$arrAgentSourceInfo.address}" tabindex="5" onfocus="if(this.value=='请输入详细街道地址')this.value='';this.style['color']='#555555'" readonly />
                        </div>
