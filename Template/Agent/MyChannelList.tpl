    	<!--S crumbs-->
<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：<a onclick="JumpPage('{au d='Agent' c='Agent' a='showChannelPager'}')" href="javascript:;">我的渠道</a><span>&gt;</span>代理商列表</div>
<!--E crumbs-->   
<div class="form_edit">
    <div class="form_hd">
        <ul>
            <li>
                <a href="javascript:;" onclick="JumpPage('{au d='Agent' c='Agent' a='showPactAgentPager'}');">
    ...
    <div class="form_bd">
        <div class="form_block_bd">
                ...
                <form action="" method="post" name="tableFilterForm" id="tableFilterForm">
                    <div class="table_filter_main" id="J_table_filter_main">
                        ...
                        <div class="table_filter_main_row">
                            ...
                            <div class="ui_text">
                                <input id="J_editTimeS" type="text" class="inpCommon inpDate" name="editTimeS" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('J_editTimeE')).focus()},maxDate:'#F{$dp.$D(\'J_editTimeE\')}'}{/literal})"/> 至
            ...
            <div class="list_link marginBottom10">
                <a class="ui_button" onclick="JumpPage('{au d='Agent' c='Agent' a='AddShow'}')" m="AgentList" v="32" ispurview="true">
