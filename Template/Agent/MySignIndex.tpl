...
<div class="table_attention marginBottom10">
    <label>提醒信息：</label>
    <span class="ui_link"><a href="javascript:;" onclick="searchAgent(1)">新签：</a>(<em>{$countRst.0.A}</em>)</span>
    <span class="ui_link"><a href="javascript:;" onclick="searchAgent(2)">续签：</a>(<em>{$countRst.0.B}</em>)</span>
    <span class="ui_link"><a href="javascript:;" onclick="searchAgent(3)">失效：</a>(<em>{$countRst.0.C}</em>)</span>
    <span class="ui_link"><a href="javascript:;" onclick="searchAgent(4)">审核退回：</a>(<em>{$countRst.0.D}</em>)</span>
    <span class="ui_link"><a href="javascript:;" onclick="searchAgent(5)">解除签约：</a>(<em>{$countRst.0.E}</em>)</span>
    <br/>
        关于预存款金额以及状态的相关说明：
        1、未到账：预存款金额账户为0。
...
<div class="list_table_main">
    <div id="J_ui_table" class="ui_table">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <th title="合同有效期"  style="width:100px">
            <div class="ui_table_thcntr">
                <div class="ui_table_thtext">合同有效期</div>
            </div>
            </th>
            <th title="虚拟合同号" style="width:100px">
            <div class="ui_table_thcntr">
            ...
            <th title="提交人" style="width:80px">
            <div class="ui_table_thcntr">
                <div class="ui_table_thtext">提交人</div>
            </div>
            </th>
            <th title="提交时间" style="width:80px">
            <div class="ui_table_thcntr">
                <div class="ui_table_thtext">提交时间</div>
            </div>
            </th>                        
            <th title="操作" style="width:130px">
            <div class="ui_table_thcntr ">
