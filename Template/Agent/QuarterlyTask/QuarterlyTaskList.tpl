...
<div class="list_link marginBottom10">
    ...
    <a m="AgentQuarterlyTaskList" ispurview="true" v="4" class="ui_button" 
    onclick="JumpPage('/?d=Agent&c=QuarterlyTask&a=QuarterlyTaskModify')" href="javascript:;">
    <div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_icon ui_icon_open"></div>
    <div class="ui_text">季度任务添加</div></div></a>
	...
	<div class="ui_table" id="J_ui_table">                    	
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        	<thead class="ui_table_hd">
            	<tr class="">                                	
                   <th width="90"><div class="ui_table_thcntr"><div class="ui_table_thtext">代理商代码</div></div></th>
                   <th width="130"><div class="ui_table_thcntr"><div class="ui_table_thtext">代理商名称</div></div></th>
                   <th width="60"><div class="ui_table_thcntr"><div class="ui_table_thtext">代理等级</div></div></th>
                   <th width="100"><div class="ui_table_thcntr"><div class="ui_table_thtext">产品名称</div></div></th>                                    
                   <th><div class="ui_table_thcntr"><div class="ui_table_thtext">季度时间</div></div></th>
                   ...
                   <th width="80"><div class="ui_table_thcntr"><div class="ui_table_thtext">添加人</div></div></th>
                   <th width="80"><div class="ui_table_thcntr"><div class="ui_table_thtext">添加时间</div></div></th>
