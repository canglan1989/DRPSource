...
<div class="list_link marginBottom10">
    <a style="margin:0;" class="ui_button ui_button_dis" href="javascript:;" onclick="PageBack();"><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_icon ui_icon_return"></div><div class="ui_text">返回</div></div></a>
</div>
<!--S list_table_head-->
<div class="list_table_head">
    <div class="list_table_head_right">
        <div class="list_table_head_mid">
            <h4 class="list_table_title"><span class="ui_icon list_table_title_icon"></span> 签约记录列表（合同号：{$arrPactInfo.pact_number}{$arrPactInfo.pact_stage}）</h4>
        </div>
    </div>			           
</div>
<!--E list_table_head-->        
...
<div class="list_table_main">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <input type="hidden" name="pactId" id="pactId" value="{$pactId}" />
