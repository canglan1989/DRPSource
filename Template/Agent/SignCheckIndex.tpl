        ...
        <div class="table_filter_main" id="J_table_filter_main">
			<div class="table_filter_main_row">  
                ...
                <div class="ui_title">代理产品：</div>                    
                    <div id="ui_comboBox_agentPro" onClick="IM.comboBox.init({literal}{'control':'agentPro',data:MM.A(this,'data')}{/literal},this)" class="ui_comboBox ui_comboBox_def" key="" value="" data='{$arrProductType}' style="width:100px;">
            ...
            <div class="table_filter_main_row">
            	<!--<div class="ui_title">战区名称：</div>
                    ...
                    <div class="ui_text">
                                <input type="text" onfocus="WdatePicker({literal}{onpicked:function(){($dp.$('J_cTimeE')).focus()},maxDate:'#F{$dp.$D(\'J_cTimeE\')}'}{/literal})" name="editTimeS" class="inpCommon inpDate" id="J_cTimeS"> 至
                                <input type="text" onfocus="WdatePicker({literal}{minDate:'#F{$dp.$D(\'J_cTimeS\')}'}{/literal})" name="editTimeE" class="inpCommon inpDate" id="J_cTimeE">
					</div>
