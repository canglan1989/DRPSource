<?php /* Smarty version 2.6.26, created on 2013-01-29 17:08:44
         compiled from Agent/AgentPotentialList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'au', 'Agent/AgentPotentialList.tpl', 7, false),)), $this); ?>
<!--S crumbs-->
...
<div class="form_edit">
  <div class="form_hd">
    <ul>
      <li> <a href="javascript:;" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'agentSigningList'), $this);?>
');">
                ...
                <form action="" method="post" name="tableFilterForm" id="tableFilterForm">
                    <div class="table_filter_main" id="J_table_filter_main">
                        <div class="table_filter_main_row"> 		
                            ...
                            <div id="ui_comboBox_IntentionRating" onclick="IM.comboBox.init(<?php echo '{\'control\':\'industry\',data:MM.A(this,\'data\')}'; ?>
,this)" class="ui_comboBox ui_comboBox_def" key="" value="" control="industry" data="<?php echo $this->_tpl_vars['industry']; ?>
" style="width:120px;">
