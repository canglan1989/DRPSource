<?php /* Smarty version 2.6.26, created on 2013-03-08 09:46:20
         compiled from CM/ContactRecord/ContactInviteList.tpl */ ?>
<!--S crumbs-->
...
<div class="table_filter marginBottom10">  
	...
	<div class="table_filter_main_row">
            ...
            <div class="ui_text">
                <input id="tbxSInviteCreateTime" type="text" class="inpCommon inpDate" name="tbxSInviteCreateTime" onClick="WdatePicker(<?php echo '{maxDate:\'#F{$dp.$D(\\\'tbxEInviteCreateTime\\\')}\'})'; ?>
"/>
                至
                <input id="tbxEInviteCreateTime" type="text" class="inpCommon inpDate" name="tbxEInviteCreateTime" onClick="WdatePicker(<?php echo '{minDate:\'#F{$dp.$D(\\\'tbxSInviteCreateTime\\\')}\'})'; ?>
"/>	
            </div>
...
$(function(){    
	...
	pageList.strUrl = "<?php echo $this->_tpl_vars['ContactInviteListBody']; ?>
"; 
	<?php echo '    
