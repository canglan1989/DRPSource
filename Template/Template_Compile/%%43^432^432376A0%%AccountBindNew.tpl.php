<?php /* Smarty version 2.6.26, created on 2012-12-11 15:06:32
         compiled from System/AreaSet/AccountBindNew.tpl */ ?>
<div class="DContInner">
<form id="J_newAccount">
	<div class="bd">
    <div class="tf">
      <label>  账号组名称： </label>
      <div class="inp"><?php echo $this->_tpl_vars['account_name']; ?>
<input type="hidden" id="account_group_id" name="account_group_id"  value="<?php echo $this->_tpl_vars['account_group_id']; ?>
"/></div>
      </div>
    <div class="tf">
