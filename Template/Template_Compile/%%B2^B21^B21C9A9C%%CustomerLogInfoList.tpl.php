<?php /* Smarty version 2.6.26, created on 2013-01-07 14:30:26
         compiled from CM/CheckManage/CustomerLogInfoList.tpl */ ?>
    ...
    <form action="" method="post" name="tableFilterForm" id="tableFilterForm">
        <div class="table_filter_main" id="J_table_filter_main">
            <div class="table_filter_main_row"> 
                ...
                <div class="ui_text"><input type="text"  style="width:200px;" id = "agent_name" name="agent_name"/></div>
...
<div class="list_table_main">
    <div id="J_ui_table" class="ui_table">
        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            ...
            <th style="width:130px" title="修改时间">
            ...
            <th style="width:120px" title="修改人">
            ...
            <th style="width:70px;" title="审核状态">
            <div class="ui_table_thcntr">
