<?php /* Smarty version 2.6.26, created on 2012-12-17 14:22:50
         compiled from FM/Backend/PactMoneyInAccountList.tpl */ ?>
<!--S crumbs-->
...
<div class="table_filter marginBottom10">  
    ...
    <div class="table_filter_main" id="J_table_filter_main">    		
        ...
        <div class="ui_text"><input type="text" name="tbxAgentNo" id="tbxAgentNo" value="<?php echo $this->_tpl_vars['agentNo']; ?>
...
var unitProductTypeID = parseInt(<?php echo $this->_tpl_vars['unitProductTypeID']; ?>
);
<?php echo ' 
$(function(){    
	...
	pageList.strUrl = "<?php echo $this->_tpl_vars['PactMoneyInAccountListBody']; ?>
"; 
	<?php echo '
    if(productTypeID > 0)
