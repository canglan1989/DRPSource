<?php /* Smarty version 2.6.26, created on 2013-01-11 11:31:50
         compiled from CM/ContactRecord/AgentContactRecordList.tpl */ ?>
<!--S crumbs-->
    ...
    <form action="" method="post" name="tableFilterForm" id="tableFilterForm">
        <div class="table_filter_main" id="J_table_filter_main">
            <div class="table_filter_main_row">
                ...
                <div class="ui_text">
                    <input id="tbxSRevisitTime" type="text" class="inpCommon inpDate" name="tbxSRevisitTime" onClick="WdatePicker(<?php echo '{maxDate:\'#F{$dp.$D(\\\'tbxERevisitTime\\\')}\'})'; ?>
"/>
                    至
                    <input id="tbxERevisitTime" type="text" class="inpCommon inpDate" name="tbxERevisitTime" onClick="WdatePicker(<?php echo '{minDate:\'#F{$dp.$D(\\\'tbxSRevisitTime\\\')}\'})'; ?>
"/>	
                </div> 
            ...
            <div class="table_filter_main_row">
                ...
                <div class="ui_comboBox">
                    <select id="cbIsVisit" name="cbIsVisit">
                        <option value="-100">请选择</option>
                        <option value="1" <?php echo $this->_tpl_vars['tp_sel1']; ?>
>拜访小记</option>
                        <option value="0" <?php echo $this->_tpl_vars['tp_sel0']; ?>
>联系小记</option>
                    </select>
                </div>
...
" style="width:240px;">
            ...
            <div class="table_filter_main_row">
                ...
                <div class="ui_text"><input type="text" name="agentname" id="agentname" value="<?php echo $this->_tpl_vars['agentName']; ?>
" style="width:100px;"/></div>	
                <div class="ui_title">是否有效联系：</div>
                <div class="ui_comboBox">
                    <select  name="IsVaildContact">
                        <option value="-100">全部</option>
                        <option value="1" <?php echo $this->_tpl_vars['tp_sel0']; ?>
>是</option>
                ...
                <div class="ui_text">
                    <input id="ContactTimeBegin" type="text" class="inpCommon inpDate" name="ContactTimeBegin" value="<?php echo $this->_tpl_vars['contact_dateb']; ?>
" onClick="WdatePicker(<?php echo '{maxDate:\'#F{$dp.$D(\\\'ContactTimeEnd\\\')}\'})'; ?>
"/>
                    至
                    <input id="ContactTimeEnd" type="text" class="inpCommon inpDate" name="ContactTimeEnd" value="<?php echo $this->_tpl_vars['contact_datee']; ?>
" onClick="WdatePicker(<?php echo '{minDate:\'#F{$dp.$D(\\\'ContactTimeBegin\\\')}\'})'; ?>
"/>	
                </div>  
