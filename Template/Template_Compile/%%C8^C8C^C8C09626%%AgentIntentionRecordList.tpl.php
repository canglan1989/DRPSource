<?php /* Smarty version 2.6.26, created on 2012-12-10 09:46:49
         compiled from CM/ContactRecord/AgentIntentionRecordList.tpl */ ?>
<!--S crumbs-->
    ...
    <div class="table_filter_main" id="J_table_filter_main">
    	<div class="table_filter_main_row">
            ...
            '; ?>
             ...
             class="ui_comboBox ui_comboBox_def" key="" value="" control="IntentionRating" data="<?php echo $this->_tpl_vars['strIntentionRatingJson']; ?>
" style="width:240px;">
            ...
            <div class="ui_text"><?php echo '
    	         ...
    	         <input id="create_time_end" type="text" class="inpCommon inpDate" name="create_time_end" onfocus="WdatePicker({minDate:\'#F{$dp.$D(\\\'create_time_begin\\\')}\'})"/>'; ?>
           ...
           <div class="ui_title">预计到账时间：</div>
            <div class="ui_text">
               <?php echo '
    	         ...
    	         <input id="income_time_end" type="text" class="inpCommon inpDate" name="income_time_end" onfocus="WdatePicker({minDate:\'#F{$dp.$D(\\\'income_time_begin\\\')}\'})"/>'; ?>
