<?php /* Smarty version 2.6.26, created on 2013-03-12 11:01:18
         compiled from System/AccountManager/AgentPactUserModify.tpl */ ?>
<!--S crumbs-->
    ...
    <div class="form_bd">
        ...
        <form id="form1" class="newAccountForm" name="form1" action="">
            <div class="tf" style="padding-top:20px;">
                <label> 所属公司：</label>
                <div class="inp"> <?php echo $this->_tpl_vars['strAgentName']; ?>
 </div>
            </div>
            ...
            <div class="tf">
                ...
                <div class="inp">
                <?php if ($this->_tpl_vars['objUserInfo']->iUserId > 0): ?>
                <input class="contactName" type="hidden" name="tbxUserName" id="tbxUserName" value="<?php echo $this->_tpl_vars['objUserInfo']->strUserName; ?>
" style="width:180px;"/>
...
<!--            <div class="tf">
                ...
                <div class="inp">
                    <input class="contactName" type="text" valid="required tbxDept" name="tbxDept" id="tbxDept" value="<?php echo $this->_tpl_vars['objUserInfo']->strDeptName; ?>
" style="width:180px;"/>
                </div>
...
" style="width:180px;"/></div>
            ...
            <div class="tf">
                <label> 停用：</label>
                <div class="inp">
                    <input class="checkInp" name="chkIsLock" id="chkIsLock" type="checkbox" value="1" <?php if ($this->_tpl_vars['objUserInfo']->iIsLock == 1): ?> checked="checked" <?php endif; ?> /> </div>
            </div>
...
<?php echo ' 
    ...
    '; ?>
            ...
            var formValues = "&agentid=<?php echo $this->_tpl_vars['agentID']; ?>
"; 		
