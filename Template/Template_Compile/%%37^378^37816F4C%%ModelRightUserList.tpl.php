<?php /* Smarty version 2.6.26, created on 2012-11-16 16:12:57
         compiled from System/ModelManager/ModelRightUserList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sdrclass', 'System/ModelManager/ModelRightUserList.tpl', 33, false),array('function', 'au', 'System/ModelManager/ModelRightUserList.tpl', 64, false),)), $this); ?>
<!--S crumbs-->
  ...
  <div class="list_table_main">
    <div id="J_ui_table" class="ui_table">
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <?php $_from = $this->_tpl_vars['arrayRightUserList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
">
            ...
            <li><a m="RoleManager" v="8" ispurview="true" href="javascript:;" onclick="DelUser(<?php echo $this->_tpl_vars['data']['user_id']; ?>
...
function DelUser(user_id,right_id)
{
    if(!confirm("您确定要删除吗？"))
        return ;
    '; ?>
...
';
    ...
    var retValue = $PostData(url,"id="+user_id+"&rightID="+right_id+"&add=false");
...
';
    <?php echo ' 
    JumpPage(\'/?d=System&c=Model&a=ModelRightUser&id=\'+id,false);
}
</script>
'; ?>
