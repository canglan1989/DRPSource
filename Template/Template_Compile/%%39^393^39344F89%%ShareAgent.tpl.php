<?php /* Smarty version 2.6.26, created on 2013-01-07 15:18:58
         compiled from Agent/ShareAgent.tpl */ ?>
<div class="DContInner">
    <form id="J_shareAgent">
        <div class="form_edit">
            <input  type="hidden" name="agent_id" value="<?php echo $this->_tpl_vars['agent_id']; ?>
"/>
            <div class="form_block_hd"></div>
            <div class="form_block_bd">
                <div class="tf">
                            <label style="width:180px;">代理商所属账号：</label>
                            <div class="inp"><?php echo $this->_tpl_vars['agentInfo']['user_name']; ?>
<?php echo $this->_tpl_vars['agentInfo']['e_name']; ?>
</div>
