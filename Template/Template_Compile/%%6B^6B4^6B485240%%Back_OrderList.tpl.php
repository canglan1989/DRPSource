<?php /* Smarty version 2.6.26, created on 2013-01-07 15:44:18
         compiled from OM/Back_OrderList.tpl */ ?>
<!--S crumbs-->
        ...
        <div id="J_table_filter_main" class="table_filter_main">
            <div class="table_filter_main_row">
                ...
                <div class="ui_text"><input id="tbxCustomerName" type="text" name="tbxCustomerName" value="" maxlength="48" /></div>      
                    <?php if ($this->_tpl_vars['product_group'] == 0): ?>                    
...
'; ?>
    ...
    var strUrl = "<?php echo $this->_tpl_vars['orderListBody']; ?>
";     
    var product_group = "<?php echo $this->_tpl_vars['product_group']; ?>
"; 
<?php echo '
