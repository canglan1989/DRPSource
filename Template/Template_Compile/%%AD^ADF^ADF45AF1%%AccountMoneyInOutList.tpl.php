<?php /* Smarty version 2.6.26, created on 2012-11-27 14:38:02
         compiled from FM/Backend/AccountMoneyInOutList.tpl */ ?>
...
<div class="table_filter marginBottom10">
    ...
    <div class="table_filter_main" id="J_table_filter_main">
		...
		<div class="ui_title">操作类型：</div>
            ...
            <?php echo '
			<div id="ui_comboBox_inOutTypes" onclick="IM.comboBox.init({\'control\':\'inOutTypes\',data:MM.A(this,\'data\')},this)" '; ?>

             class="ui_comboBox ui_comboBox_def" key="<?php echo $this->_tpl_vars['qInOutTypes']; ?>
" value="<?php echo $this->_tpl_vars['qInOutTypeNames']; ?>
" control="inOutTypes" data="<?php echo $this->_tpl_vars['strInOutTypeJson']; ?>
" style="width:220px;"> 
             <div class="ui_comboBox_text" style="width:200px;">
                <?php if ($this->_tpl_vars['qInOutTypeNames'] == ""): ?>
                <nobr>全部</nobr>
                <?php else: ?>
                <nobr><?php echo $this->_tpl_vars['qInOutTypeNames']; ?>
</nobr>
                <?php endif; ?>
            </div>
...
<script language="javascript" type="text/javascript">
 $(function(){
    ...
    var accountType = parseInt(<?php echo $this->_tpl_vars['qAccountType']; ?>
);
    var dataType = parseInt(<?php echo $this->_tpl_vars['qDataType']; ?>
);
    var inOutType = parseInt(<?php echo $this->_tpl_vars['qInOutType']; ?>
);
    var agentNo = "<?php echo $this->_tpl_vars['qAgentNo']; ?>
";
    
	pageList.strUrl = "<?php echo $this->_tpl_vars['AccountMoneyInOutListBody']; ?>
"; 
	<?php echo '
