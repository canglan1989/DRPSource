<?php /* Smarty version 2.6.26, created on 2013-01-07 14:30:13
         compiled from CM/InfoListBack.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'au', 'CM/InfoListBack.tpl', 48, false),)), $this); ?>
<!--S crumbs-->
...
<div class="list_link marginBottom10">
    <a m='showBackInfoList' v="4" ispurview="true" class="ui_button" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'CM','c' => 'CMInfo','a' => 'showInsertBack'), $this);?>
')"><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_icon ui_icon_add"></div><div class="ui_text">客户录入</div></div></a>
