<?php /* Smarty version 2.6.26, created on 2012-11-21 14:27:31
         compiled from Agent/ReportManage/AgentAdhaiList.tpl */ ?>
<!--S crumbs-->
...
<div class="table_attention marginBottom10">
    <label>统计信息：</label>
    <span class="ui_link">今日新开：(<em><?php echo $this->_tpl_vars['TodayNew']; ?>
</em>)</span>
    <span class="ui_link">本月累计新开：(<em><?php echo $this->_tpl_vars['MonthNew']; ?>
</em>)</span>
    <span class="ui_link">今日续费：(<em><?php echo $this->_tpl_vars['TodayOld']; ?>
</em>)</span>
    <span class="ui_link">本月累计续费：(<em><?php echo $this->_tpl_vars['MonthOld']; ?>
</em>)</span>
    <br  />
    <span class="ui_link">今日新开总金额：(<em><?php echo $this->_tpl_vars['TodayNewMoney']; ?>
</em>)</span>
    <span class="ui_link">本月累计新开总金额：(<em><?php echo $this->_tpl_vars['MonthNewMoney']; ?>
</em>)</span>
    <span class="ui_link">今日续费总金额：(<em><?php echo $this->_tpl_vars['TodayOldMoney']; ?>
</em>)</span>
    <span class="ui_link">本月累计续费总金额：(<em><?php echo $this->_tpl_vars['MonthOldMoney']; ?>
</em>)</span>
</div> 
<!--S table_filter-->
<!--S table_filter-->
