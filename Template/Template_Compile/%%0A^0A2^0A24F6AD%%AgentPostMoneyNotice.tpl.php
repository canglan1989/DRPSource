<?php /* Smarty version 2.6.26, created on 2012-11-27 14:38:09
         compiled from FM/Backend/AgentPostMoneyNotice.tpl */ ?>
<!--S crumbs-->
...
<div class="table_attention marginBottom10">
    ...
    <?php $_from = $this->_tpl_vars['arrayAccountBalanceWarning']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['data']):
?>    
    <span class="ui_link"><?php echo $this->_tpl_vars['data']['product_type_name']; ?>
：保证金(<em><?php echo $this->_tpl_vars['data']['gua_balance_warning']; ?>
</em>)&nbsp;预存款(<em><?php echo $this->_tpl_vars['data']['pre_balance_warning']; ?>
</em>)</span>
    <?php if ($this->_tpl_vars['index'] > 0 && ( $this->_tpl_vars['index']+1 ) % 3 == 0): ?>
    <br />
    <?php endif; ?>
...
<div class="table_filter marginBottom10">  
    ...
    <div class="table_filter_main" id="J_table_filter_main">    		
    	<div class="table_filter_main_row">
           <div class="ui_title"><input type="hidden" value="<?php echo $this->_tpl_vars['iGuaMoney']; ?>
" id="tbxGuaMoney" name="tbxGuaMoney" />
           <input type="hidden" value="<?php echo $this->_tpl_vars['iUnitGuaMoney']; ?>
" id="tbxUnitGuaMoney" name="tbxUnitGuaMoney" />
           <input type="hidden" value="<?php echo $this->_tpl_vars['iPreMoney']; ?>
" id="tbxPreMoney" name="tbxPreMoney" />
           <input type="hidden" value="<?php echo $this->_tpl_vars['iUnitPreMoney']; ?>
" id="tbxUnitPreMoney" name="tbxUnitPreMoney" />
           代理商代码：</div>
...
$(function(){    
    ...
    var productTypeID = parseInt(<?php echo $this->_tpl_vars['qProductTypeID']; ?>
);
	pageList.strUrl = "<?php echo $this->_tpl_vars['AgentPostMoneyNoticeListBody']; ?>
"; 
	<?php echo '        
