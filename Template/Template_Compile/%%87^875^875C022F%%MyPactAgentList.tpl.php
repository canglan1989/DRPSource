<?php /* Smarty version 2.6.26, created on 2012-12-10 10:14:44
         compiled from Agent/MyPactAgentList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'au', 'Agent/MyPactAgentList.tpl', 3, false),)), $this); ?>
<!--S crumbs-->

<div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：<a onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'showPactAgentPager'), $this);?>
')" href="javascript:";>我的渠道</a><span>&gt;</span>代理商列表</div>
<!--E crumbs-->
<div class="form_edit">
<div class="form_hd">
  <ul>
    <li class="cur"><a href="javascript:;" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'showPactAgentPager'), $this);?>
');">
    ...
    <li><a href="javascript:;" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'showChannelPager'), $this);?>
');">
      <div class="form_hd_left">
        <div class="form_hd_right">
          <div class="form_hd_mid">
...
<div class="form_bd">
  <div class="form_block_bd"> 
    ...
    <!--E table_filter--> 
    <!--S list_link-->
    <div class="list_link marginBottom10"> <a class="ui_button" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'AddShow'), $this);?>
')" m="AgentList" v="32" ispurview="true" style="margin:0;">
