<?php /* Smarty version 2.6.26, created on 2012-12-11 15:06:24
         compiled from System/AreaSet/AccountBindList.tpl */ ?>
  <!--E crumbs-->
  <div class="crumbs marginBottom10"><em class="icon_crumbs"></em>当前位置：<?php echo $this->_tpl_vars['strPath']; ?>
   ...
   <div class="table_filter_main_row">
    ...
    <div class="ui_button ui_button_search">
        <button class="ui_button_inner" type="button" onclick="QueryData(<?php echo $this->_tpl_vars['id']; ?>
)">搜 索</button>
    </div>
</div>
   </div>
    ...
    <div class="list_link marginBottom10">
        <a class="ui_button" onclick="addAccountBind(<?php echo $this->_tpl_vars['id']; ?>
)"
        ...
        <a class="ui_button" style="margin:0" onclick="Transfer(<?php echo $this->_tpl_vars['id']; ?>
)" href="javascript:;" v="4" ispurview="true" m="AccountAreaList">
            <div class="ui_button_left"></div>
                <div class="ui_button_inner">
    ...
    <div class="list_table_head_right">
 	<div class="list_table_head_mid">
		<h4 class="list_table_title"><span class="ui_icon list_table_title_icon"></span>账号组名称：<?php echo $this->_tpl_vars['strTitle']; ?>
</h4>
...
$(document).ready(function () {
	...
	pageList.strUrl="<?php echo $this->_tpl_vars['AccountBindBody']; ?>
"; 
   
    pageList.param = "&id="+<?php echo $this->_tpl_vars['id']; ?>
;
    <?php echo '
