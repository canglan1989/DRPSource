<?php /* Smarty version 2.6.26, created on 2012-12-31 18:00:06
         compiled from Agent/ChannelList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'au', 'Agent/ChannelList.tpl', 5, false),)), $this); ?>
...
?>
<tr>
    <td title=""><div class="ui_table_tdcntr"><input class="checkInp" type="checkbox" name="listid" value="<?php echo $this->_tpl_vars['arrcheckList']['agent_id']; ?>
"/></div></td>
...
"><div class="ui_table_tdcntr"><?php echo $this->_tpl_vars['arrcheckList']['intention_level']; ?>
    ...
    <td title="<?php if ($this->_tpl_vars['arrcheckList']['agent_from'] == 0): ?>我录入的<?php elseif ($this->_tpl_vars['arrcheckList']['agent_from'] == 1): ?>自动注册<?php else: ?>上级分配<?php endif; ?>"><div class="ui_table_tdcntr"><?php if ($this->_tpl_vars['arrcheckList']['agent_from'] == 0): ?>我录入的<?php elseif ($this->_tpl_vars['arrcheckList']['agent_from'] == 1): ?>自动注册<?php else: ?>上级分配<?php endif; ?></div></td>                                    
...
(<?php echo $this->_tpl_vars['arrcheckList']['user_name']; ?>
    ...
    <td title="<?php if ($this->_tpl_vars['arrcheckList']['is_check'] == 0): ?>未审核<?php elseif ($this->_tpl_vars['arrcheckList']['is_check'] == 1): ?>审核通过<?php else: ?>审核不通过<?php endif; ?>">
...
<br/>
    <?php if ($this->_tpl_vars['arrcheckList']['update_time'] != '' && $this->_tpl_vars['arrcheckList']['update_time'] != '0000-00-00 00:00:00'): ?><?php echo $this->_tpl_vars['arrcheckList']['update_time']; ?>
    ...
    <td>
        <div class="ui_table_tdcntr">
            ...
            <ul class="list_table_operation">
                <li><a m="AgentList" v="8" ispurview="true" href="javascript:;" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'showAgentinfoAddContact'), $this);?>
&agentId=<?php echo $this->_tpl_vars['arrcheckList']['agent_id']; ?>
&checkStatus=<?php echo $this->_tpl_vars['arrcheckList']['is_check']; ?>
&needCheck=yes&isPact=no');">联系小记</a></li>
                <li><a m="TelTaskManage" v="4" ispurview="true" href="javascript:;" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'WorkM','c' => 'TelWork','a' => 'showAddTelInvite'), $this);?>
&agentid=<?php echo $this->_tpl_vars['arrcheckList']['agent_id']; ?>
');">设置电话任务</a></li>
                <!--<li><a m="AgentList" v="16" ispurview="true" href="javascript:;" onclick="JumpPage('<?php echo getSmartyActionUrl(array('d' => 'Agent','c' => 'Agent','a' => 'showAgentInfo'), $this);?>
&agentId=<?php echo $this->_tpl_vars['arrcheckList']['agent_id']; ?>
&checkStatus=<?php echo $this->_tpl_vars['arrcheckList']['is_check']; ?>
&type=1&needCheck=yes&fromType=1&isPact=no');">详细</a></li>-->
