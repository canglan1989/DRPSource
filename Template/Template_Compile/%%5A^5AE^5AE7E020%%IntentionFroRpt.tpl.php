<?php /* Smarty version 2.6.26, created on 2013-03-08 09:46:54
         compiled from CM/IntentionFroRpt.tpl */ ?>
<!--S crumbs-->
...
"/>
					...
					<div class="ui_text"  id = "createTime">
            	            <input id="J_editTimeS" type="text" class="inpCommon inpDate" name="rep_date" value="<?php echo $this->_tpl_vars['rep_date']; ?>
" onClick="WdatePicker(<?php echo '{isShowClear:false})'; ?>
"/> 
					</div>
...
";
     ...
     {
        window.open("/?d=CM&c=CMReport&a=excelExportIntentionFroRpt" + pageList.param + "&sortField=" + pageList.sortField);
     }
