<?php /* Smarty version 2.6.26, created on 2013-03-08 09:44:07
         compiled from CM/PublicPool/showPublicPoolList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'au', 'CM/PublicPool/showPublicPoolList.tpl', 60, false),)), $this); ?>
...
<select id="industry_id" name="industry_id"></select></div>
            ...
            '; ?>
             ...
             class="ui_comboBox ui_comboBox_def" key="<?php echo $this->_tpl_vars['qProductTypeIDs']; ?>
" value="<?php echo $this->_tpl_vars['qProductTypeNames']; ?>
" control="Pro" data="<?php echo $this->_tpl_vars['strProductTypeJson']; ?>
" style="width:100px;">
             <div class="ui_comboBox_text" style="width:80px;">
                    <?php if ($this->_tpl_vars['qProductTypeNames'] == ""): ?>
                	<nobr>请选择</nobr>
                    <?php else: ?>
                	<nobr><?php echo $this->_tpl_vars['qProductTypeNames']; ?>
</nobr>
                    <?php endif; ?>
                </div>
...
<!--    <a class="ui_button " m="PublicPoolManager" ispurview="true" v="4" href="javascript:;" onClick='JumpPage("<?php echo getSmartyActionUrl(array('d' => 'CM','c' => 'CMPublicPool','a' => 'showExcelAdd'), $this);?>
")'><div class="ui_button_left"></div><div class="ui_button_inner"><div class="ui_icon ui_icon_open"></div><div class="ui_text">导入客户</div></div></a>-->
</div>
<!--E list_link-->
<!--S list_table_head-->
...
<script>
    var DefendUrl = '<?php echo getSmartyActionUrl(array('d' => 'CM','c' => 'CMPublicPool','a' => 'DefendCustomer'), $this);?>
';
    <?php echo '
$(document).ready(function(){
    ...
    pageList.strUrl='; ?>
"<?php echo $this->_tpl_vars['BodyUrl']; ?>
"<?php echo ';    
