<?php /* Smarty version 2.6.26, created on 2012-12-18 17:30:34
         compiled from Agent/WorkManagement/CheckList.tpl */ ?>
<!--E crumbs-->
    ...
    <form action="" method="post" id="tableFilterForm" name="tableFilterForm">
        <div class="table_filter_main" id="J_table_filter_main">    		
            <div class="table_filter_main_row">
                ...
                <div class="ui_text">
                    <input id="create_name" class="inpCommon" type="text" name="create_name" value="<?php echo $this->_tpl_vars['countname']; ?>
" style="vertical-align:top;"/>
                </div>
                <div class="ui_title">小记制定时间：</div>
                <div class="ui_text">
                    <input id="J_editTimeS" class="inpDate" name="create_timeb" value="<?php echo $this->_tpl_vars['counttimeb']; ?>
...
" type="text"/> 至
                    <input id="J_editTimeE" class="inpDate" name="create_timee" value="<?php echo $this->_tpl_vars['counttimee']; ?>
" onfocus="WdatePicker(<?php echo '{minDate:\'#F{$dp.$D(\\\'J_editTimeS\\\')}\',dateFmt:\'yyyy-MM-dd HH:mm:ss\'}'; ?>
)" type="text"/>	
                    <input type="hidden" id="countname" name="countname" value="<?php echo $this->_tpl_vars['countname']; ?>
" />
                    <input type="hidden" id="counttimeb" name="counttimeb" value="<?php echo $this->_tpl_vars['counttimeb']; ?>
" />
                    <input type="hidden" id="counttimee" name="counttimee" value="<?php echo $this->_tpl_vars['counttimee']; ?>
" />
                </div>
...
<!--                <div class="ui_text">
            ...
            <div class="table_filter_main_row">                         
                ...
                <?php if ($this->_tpl_vars['countname'] == ""): ?>                     						
            ...
            <div class="ui_title">拜访时间：</div>
                <div class="ui_text">
                    <input id="J_VistTimeS" class="inpCommon inpDate" name="tbxSVistDate" value="" onfocus="WdatePicker(<?php echo '{onpicked:function(){($dp.$(\'J_VistTimeE\')).focus()},dateFmt:\'yyyy-MM-dd\',maxDate:\'#F{$dp.$D(\\\'J_VistTimeE\\\')}\'})'; ?>
" type="text"/> 至
                    <input id="J_VistTimeE" class="inpCommon inpDate" name="tbxEVistDate" value="" onfocus="WdatePicker(<?php echo '{minDate:\'#F{$dp.$D(\\\'J_VistTimeS\\\')}\',dateFmt:\'yyyy-MM-dd\'}'; ?>
)" type="text"/>	
                </div>
...
<?php echo ' 
    ...
    '; ?>
            ...
            pageList.strUrl="<?php echo $this->_tpl_vars['CheckListBody']; ?>
"; 
    <?php echo '
