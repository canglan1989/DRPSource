<?php /* Smarty version 2.6.26, created on 2013-01-07 14:30:41
         compiled from CM/CheckManage/ContactLogInfoBody.tpl */ ?>

<?php $_from = $this->_tpl_vars['arrayData']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['data']):
?>
  <tr>
    <td title=""><div class="ui_table_tdcntr" name="oldValue"><?php echo $this->_tpl_vars['data']['change_values']; ?>
</div></td>
    <td title=""><div class="ui_table_tdcntr" name="newValue"><?php echo $this->_tpl_vars['data']['change_values']; ?>
</div></td>
    <td title=""><div class="ui_table_tdcntr"><?php echo $this->_tpl_vars['data']['check_type_cn']; ?>
</div></td>
    <td title=""><div class="ui_table_tdcntr"><a href="javascript:void(0)" onclick="showConatctCard(<?php echo $this->_tpl_vars['data']['contact_id']; ?>
...
"><div class="ui_table_tdcntr"><a href="javascript:void(0)" onclick="UserDetial(<?php echo $this->_tpl_vars['data']['create_uid']; ?>
    ...
    <td title="<?php echo $this->_tpl_vars['data']['check_state_cn']; ?>
"><div class="ui_table_tdcntr"><a href="javascript:void(0)" onclick="showCheckPage('<?php echo $this->_tpl_vars['data']['aid']; ?>
')"><?php echo $this->_tpl_vars['data']['check_state_cn']; ?>
</a></div></td>
  </tr>
