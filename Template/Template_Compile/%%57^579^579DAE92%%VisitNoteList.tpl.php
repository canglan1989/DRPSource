<?php /* Smarty version 2.6.26, created on 2013-01-31 14:37:57
         compiled from Agent/WorkManagement/VisitNoteList.tpl */ ?>
<!--E crumbs-->
...
" name="agent_id" />
        ...
        <input id="create_time_start" type="text" class="inpCommon inpDate" name="create_timeb" onfocus="WdatePicker(<?php echo '{onpicked:function(){($dp.$(\'create_time_end\')).focus()},maxDate:\'#F{$dp.$D(\\\'create_time_end\\\')}\'}'; ?>
)"/> 至
        <input id="create_time_end" type="text" class="inpCommon inpDate" name="create_timee" onfocus="WdatePicker(<?php echo '{minDate:\'#F{$dp.$D(\\\'create_time_start\\\')}\'}'; ?>
)"/>
        </div>
      ...
      <div class="table_filter_main_row">
        <div id="J_level">
          ...
          <div style="width:100px;" id="agent_level" data="[<?php echo '{\'key\':\'A\',\'value\':\'A\'},{\'key\':\'B+\',\'value\':\'B+\'},{\'key\':\'B-\',\'value\':\'B-\'},{\'key\':\'C\',\'value\':\'C\'},{\'key\':\'D\',\'value\':\'D\'},{\'key\':\'E\',\'value\':\'E\'}'; ?>
