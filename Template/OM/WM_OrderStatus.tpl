        ...
        <div class="ui_table ui_table_nohead">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tbody class="ui_table_bd" id="ListContent">
                    {foreach from=$arrayStatus item=data key=index}
                        <tr>
                            <td><div class="ui_table_tdcntr">{$data.step}</div></td>
                            <td><div class="ui_table_tdcntr">{$data.act_user}</div></td>
                            <td><div class="ui_table_tdcntr">{$data.act_time}</div></td>
                            <td><div class="ui_table_tdcntr">{$data.result}</div></td>
