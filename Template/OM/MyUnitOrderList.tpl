...
<div class="list_link marginBottom10">
    ...
    onclick="JumpPage('/?d=OM&c=Order&a=UnitOrderPostStep1')" href="javascript:;" style="margin:0">
	...
	<div id="J_ui_table" class="ui_table">
    	<table width="100%" cellspacing="0" cellpadding="0" border="0">
        	...
        	<tr>
                ...
                <th style="width:100px;" title="提交时间">
                	<div class="ui_table_thcntr ">
...
<script language="javascript" type="text/javascript">
 $(function(){
    ...
    cbDataBind.OrderTypes("cbOrderType");
   	{/literal}
	var strUrl = "{$MyUnitOrderListBody}"; 
	{literal}
...
//退单
function BackOrder(obj,id)
{
    if(!confirm("您确定要退单吗？"))
        return ;
        
    var data = $PostData("/?d=OM&c=Order&a=BackOrder","id="+id);
    if(parseInt(data) == 0)
    {
        IM.tip.show("退单成功！");
        pageList.reflash();
