    ...
    <div class="form_block_bd">
        ...
        <div id="J_domainArea">
        	...
        	<div class="tf">
                ...
                <div class="inp">
                    <input name="tbxWebSite" type="text" id="tbxWebSite" valid="required" size="30" maxlength="50" value="{$data.website_name}"/>
                </div>
            ...
            <div class="tf">
	            ...
	            <label style="width:70px">域名名称：</label>
	            <div class="inp">
	               	 <input value="" type="text" valid="required" style="width:300px;" maxlength="50" name="tbxWebSite"/>
	            </div>
	            <span class="info">请输入域名名称</span>
				<span class="ok">&nbsp;</span><span class="err">请输入域名名称</span>
    		</div>
