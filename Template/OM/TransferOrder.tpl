<div class="DContInner setPWDComfireCont">
    <form id="J_backForm" name="J_backForm">
        <div class="bd">   
            <div class="tf">
                <label>订单号：</label>
                <div class="inp">{$OrderInfo.order_no}
                    <input type="hidden" name="from_agent_id" value="{$OrderInfo.agent_id}" />
                </div>
            </div>       
            <div class="tf">
                <label>客户名称：</label>
                <div class="inp">{$OrderInfo.customer_name}</div>
            </div> 
            <div class="tf">
                <label>客户网盟账号：</label>
                <div class="inp">{$OrderInfo.owner_account_name}</div>
            </div>
            <div class="tf">
                <label>所属代理商：</label>
                <div class="inp">{$OrderInfo.agent_name}({$OrderInfo.user_name})</div>
            </div>  
            <div class="tf">
                <label>转入的代理商：</label>
                <div class="inp">
