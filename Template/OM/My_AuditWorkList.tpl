...
<div class="table_filter marginBottom10">  
    ...
    <div class="table_filter_main_row">
        ...
        <div class="ui_text">
            <input id="J_editTimeS1" type="text" class="inpCommon inpDate" name="tbxAlloltSDate" onClick="WdatePicker({literal}{maxDate:'#F{$dp.$D(\'J_editTimeE1\')}'}){/literal}"/>
            至
            <input id="J_editTimeE1" type="text" class="inpCommon inpDate" name="tbxAlloltEDate" onClick="WdatePicker({literal}{minDate:'#F{$dp.$D(\'J_editTimeS1\')}'}){/literal}"/>	
        </div> 
...
var _InDealWith = false;
 $(function(){
	...
	{/literal}
	pageList.strUrl = "{$My_AuditWorkListBody}"; 
	{literal}
