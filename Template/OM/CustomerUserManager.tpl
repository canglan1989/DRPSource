...
<div class="table_filter marginBottom10">  
    ...
    <div class="table_filter_main_row">
        ...
        <div class="ui_text"><input id="tbxCustomerNo" type="text" name="tbxCustomerNo" value="" maxlength="48" /></div>
	...
	<div id="J_ui_table" class="ui_table">
    	<table width="100%" cellspacing="0" cellpadding="0" border="0">
        	...
        	<tr>
                ...
                <th style="width:80px;" title="开通时间">
                	<div class="ui_table_thcntr ">
...
<script language="javascript" type="text/javascript">
 $(function(){
	...
	{/literal}
	pageList.strUrl = "{$customerUserManagerBody}"; 
	{literal}
 ...
 function OpenCustomerUser(id)
 {
    var data = $PostData("/?d=OM&c=CustomerUser&a=LockCustomerUser&islock=0&id="+id,"");
    if(parseInt(data) == 0)
    {
        IM.tip.show("开启账户成功！"); 
        pageList.reflash();
 ...
 function LockCustomerUser(id)
 {
     var data = $PostData("/?d=OM&c=CustomerUser&a=LockCustomerUser&islock=1&id="+id,"");
    if(parseInt(data) == 0)
    {
        IM.tip.show("停用账户成功！"); 
        pageList.reflash();
 ...
 {
    var data = $PostData("/?d=OM&c=CustomerUser&a=ResetPwd&id="+id,"");
    var jsonObj = eval("("+ data +")");
    if(jsonObj["success"] == true)
    {
        IM.tip.show(jsonObj["msg"]); 
    }
    else
    {
