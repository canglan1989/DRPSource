                ...
                <form id="j_agentForm">
                    <div class="common_tf" onmousemove="this.style['background']='#FFF5F5'" onmouseout="this.style['background']='#fff'">
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="agent_name"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="area"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="product_name"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" class="inpDate" name="deadline" onfocus={literal}"WdatePicker({dateFmt:'yyyy-MM-dd'})"{/literal}></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="ensure_money"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="deposits"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="sign_name"></div>
                        ...
                        <div class="tf noMargin">
                            ...
                            <div class="inp"><input type="text" valid="required" name="status"></div>
                    ...
                    <div class="common_tf" onmousemove="this.style['background']='#FFF5F5'" onmouseout="this.style['background']='#fff'">
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="visit_rate"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="visit_num"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="real_visit"></div>
                        ...
                        <div class="tf noMargin">
                            ...
                            <div class="inp"><input type="text" valid="required" name="adhai_online_num"></div>
                    ...
                    <div class="common_tf" onmousemove="this.style['background']='#FFF5F5'" onmouseout="this.style['background']='#fff'">
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="signed_customer"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="new_customer"></div>
                        ...
                        <div class="tf noMargin">
                            ...
                            <div class="inp"><input type="text" valid="required" name="follow_customer"></div>
                    ...
                    <div class="common_tf" onmousemove="this.style['background']='#FFF5F5'" onmouseout="this.style['background']='#fff'">
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="coordinate"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="group_name"></div>
                        ...
                        <div class="tf">
                            ...
                            <div class="inp"><input type="text" valid="required" name="group_center_coordinate"></div>
                        ...
                        <div class="tf noMargin">
                            ...
                            <div class="inp"><textarea valid="required" style="height: 80px;" name="group_coordinate"></textarea></div>
