...
$server = new SoapServer(($sys_evn == 2? "AddCus_Service_Net.wsdl":"AddCus_Service_Net_test.wsdl"), array('soap_version' => SOAP_1_2));
$server->setClass("AddCus_Service_Net");
$server->handle();
?>